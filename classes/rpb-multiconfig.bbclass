...
copy_arm64_kernel_modules_to_rootfs () {
	tar -xpf ${MC_ARM64_DEPLOY_DIR_IMAGE}/modules-${RPB_MULTICONFIG_MACHINE_KERNEL}.tgz -C ${IMAGE_ROOTFS}
...
ROOTFS_POSTPROCESS_COMMAND += "copy_arm64_kernel_modules_to_rootfs; "

do_deploy_arm64_kernel() {
	cp -P ${MC_ARM64_DEPLOY_DIR_IMAGE}/* ${DEPLOY_DIR_IMAGE}
}
addtask do_deploy_arm64_kernel after do_image before do_image_complete
